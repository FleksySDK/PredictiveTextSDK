...
public class DemoFKCoreButton2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GetObjectHit(ref last_hit, "Button2"))
        {
            ...
            if (m_state == 0)
            {
                ...
                Debug.Log("Touch interaction detected Button2!");
               ...
               // Debug.Log("GetLastWord: " + tmp);

                fKCoreXR.NextWordPrediction(tmp, 1, tmp.Length);
